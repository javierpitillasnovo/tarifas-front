...
import { iCombinacionFactorValorTarifa } from '../../../../../core/interfaces/general.interface';
import { CombinacionesFactoresTarifaService } from '../../../../../core/services/combinaciones-factores-tarifa.service';

@Component({
	selector: 'app-modal-delete-combinacion-factor-precio',
	standalone: true,
	imports: [ReactiveFormsModule, UiButtonComponent],
	templateUrl: './modal-delete-combinacion-factor-precio.component.html',
	styleUrl: './modal-delete-combinacion-factor-precio.component.scss',
	changeDetection: ChangeDetectionStrategy.OnPush
})
export class ModalDeleteCombinacionFactorPrecioComponent implements OnDestroy {
	...
	deleteRiesgo() {
		this.#combinacionesFactoresTarifaService.deleteCombinacionFactorPrecio(this.combinacionFactor().id as string)
